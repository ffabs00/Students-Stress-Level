...
def KNN(x_train, x_test, y_train, y_test):
    ...
    save_path = os.path.join(project_root, 'results', 'K-Nearest Neighbors', 'cm_knn.png')
    ...
    feature_selection_methods = {
        ...
        "Forward Selection": SequentialFeatureSelector(KNeighborsClassifier(), n_features_to_select=5, direction='forward'),
        "Backward Selection": SequentialFeatureSelector(KNeighborsClassifier(), n_features_to_select=5, direction='backward'),
        "Exhaustive Search": SequentialFeatureSelector(KNeighborsClassifier(), n_features_to_select=5),
    ...
    shap_path = os.path.join(project_root, 'results', 'K-Nearest Neighbors', 'shap_knn.png')
