...
def LogRegression(x_train, x_test, y_train, y_test, seed):
    ...
    save_path = os.path.join(project_root, 'results', 'Logistic Regression', 'cm_lr.png')
    ...
    feature_selection_methods = {
        ...
        "Forward Selection": SequentialFeatureSelector(LogisticRegression(max_iter=10000), n_features_to_select=5, direction='forward'),
        "Backward Selection": SequentialFeatureSelector(LogisticRegression(max_iter=10000), n_features_to_select=5, direction='backward'),
        "Exhaustive Search": SequentialFeatureSelector(LogisticRegression(max_iter=10000), n_features_to_select=5),
    ...
    shap_path = os.path.join(project_root, 'results', 'Logistic Regression', 'shap_lr.png')
